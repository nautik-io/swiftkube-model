...
public extension core.v1 {
	...
	struct EndpointsList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = core.v1.Endpoints
		///
		...
		///
		public let kind: String = "EndpointsList"
		///
		...
		/// List of endpoints.
		///
		public var items: [core.v1.Endpoints]
		///
...
/// Codable conformance
///
public extension core.v1.EndpointsList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([core.v1.Endpoints].self, forKey: .items)
	}
...
// MARK: - core.v1.EndpointsList + Sequence
