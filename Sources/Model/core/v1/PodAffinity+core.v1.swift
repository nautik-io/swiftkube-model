...
/// Codable conformance
///
public extension core.v1.PodAffinity {
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(preferredDuringSchedulingIgnoredDuringExecution, forKey: .preferredDuringSchedulingIgnoredDuringExecution)
		try encodingContainer.encode(requiredDuringSchedulingIgnoredDuringExecution, forKey: .requiredDuringSchedulingIgnoredDuringExecution)
	}
}
