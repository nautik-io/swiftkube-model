...
public extension core.v1 {
	...
	struct NodeSystemInfo: KubernetesResource {
		...
		///
		public var swap: core.v1.NodeSwapStatus?
		///
		...
		public init(
			...
			osImage: String,
			swap: core.v1.NodeSwapStatus? = nil,
			systemUUID: String
		) {
...
public extension core.v1.NodeSystemInfo {
	...
	init(from decoder: Decoder) throws {
		...
		self.swap = try container.decodeIfPresent(core.v1.NodeSwapStatus.self, forKey: .swap)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(swap, forKey: .swap)
