...
public extension core.v1 {
	...
	struct EnvVarSource: KubernetesResource {
		...
		///
		public var fileKeyRef: core.v1.FileKeySelector?
		///
		...
		public init(
			...
			fileKeyRef: core.v1.FileKeySelector? = nil,
...
public extension core.v1.EnvVarSource {
	...
	init(from decoder: Decoder) throws {
		...
		self.fileKeyRef = try container.decodeIfPresent(core.v1.FileKeySelector.self, forKey: .fileKeyRef)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(fileKeyRef, forKey: .fileKeyRef)
