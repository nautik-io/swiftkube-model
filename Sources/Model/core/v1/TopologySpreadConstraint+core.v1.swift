...
public extension core.v1 {
	...
	struct TopologySpreadConstraint: KubernetesResource {
		...
		///
		public var nodeAffinityPolicy: String?
		///
		/// NodeTaintsPolicy indicates how we will treat node taints when calculating pod topology spread skew. Options are: - Honor: nodes without taints, along with tainted nodes for which the incoming pod has a toleration, are included. - Ignore: node taints are ignored. All nodes are included.
		///
		/// If this value is nil, the behavior is equivalent to the Ignore policy.
		///
		public var nodeTaintsPolicy: String?
		///
		...
		public init(
			...
			nodeAffinityPolicy: String? = nil,
			nodeTaintsPolicy: String? = nil,
			topologyKey: String,
			...
			self.nodeAffinityPolicy = nodeAffinityPolicy
			self.nodeTaintsPolicy = nodeTaintsPolicy
...
public extension core.v1.TopologySpreadConstraint {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case nodeAffinityPolicy = "nodeAffinityPolicy"
		case nodeTaintsPolicy = "nodeTaintsPolicy"
	...
	init(from decoder: Decoder) throws {
		...
		self.nodeAffinityPolicy = try container.decodeIfPresent(String.self, forKey: .nodeAffinityPolicy)
		self.nodeTaintsPolicy = try container.decodeIfPresent(String.self, forKey: .nodeTaintsPolicy)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(nodeAffinityPolicy, forKey: .nodeAffinityPolicy)
		try encodingContainer.encode(nodeTaintsPolicy, forKey: .nodeTaintsPolicy)
