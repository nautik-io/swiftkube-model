...
public extension core.v1 {
	...
	struct LimitRangeList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = core.v1.LimitRange
		///
...
/// Codable conformance
///
public extension core.v1.LimitRangeList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([core.v1.LimitRange].self, forKey: .items)
	}
...
// MARK: - core.v1.LimitRangeList + Sequence
