...
public extension core.v1 {
	...
	struct Volume: KubernetesResource {
		...
		///
		public var image: core.v1.ImageVolumeSource?
		///
		...
		public init(
			...
			image: core.v1.ImageVolumeSource? = nil,
...
public extension core.v1.Volume {
	...
	init(from decoder: Decoder) throws {
		...
		self.image = try container.decodeIfPresent(core.v1.ImageVolumeSource.self, forKey: .image)
