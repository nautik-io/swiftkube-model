...
public extension core.v1 {
	...
	struct PodStatus: KubernetesResource {
		...
		///
		public var extendedResourceClaimStatus: core.v1.PodExtendedResourceClaimStatus?
		///
		...
		public init(
			...
			extendedResourceClaimStatus: core.v1.PodExtendedResourceClaimStatus? = nil,
			hostIP: String? = nil,
			...
			self.extendedResourceClaimStatus = extendedResourceClaimStatus
			self.hostIP = hostIP
...
public extension core.v1.PodStatus {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case extendedResourceClaimStatus = "extendedResourceClaimStatus"
		case hostIP = "hostIP"
	...
	init(from decoder: Decoder) throws {
		...
		self.extendedResourceClaimStatus = try container.decodeIfPresent(core.v1.PodExtendedResourceClaimStatus.self, forKey: .extendedResourceClaimStatus)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(extendedResourceClaimStatus, forKey: .extendedResourceClaimStatus)
