...
public extension core.v1.PodSpec {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case hostnameOverride = "hostnameOverride"
	...
	init(from decoder: Decoder) throws {
		...
		self.hostnameOverride = try container.decodeIfPresent(String.self, forKey: .hostnameOverride)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(hostnameOverride, forKey: .hostnameOverride)
