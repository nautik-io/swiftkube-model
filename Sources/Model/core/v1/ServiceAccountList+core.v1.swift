...
// MARK: - core.v1.ServiceAccountList
...
public extension core.v1 {
	...
	struct ServiceAccountList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = core.v1.ServiceAccount
		///
		...
		///
		public let kind: String = "ServiceAccountList"
		///
		...
		///
		public var items: [core.v1.ServiceAccount]
		///
...
/// Codable conformance
///
public extension core.v1.ServiceAccountList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([core.v1.ServiceAccount].self, forKey: .items)
	}
...
// MARK: - core.v1.ServiceAccountList + Sequence
