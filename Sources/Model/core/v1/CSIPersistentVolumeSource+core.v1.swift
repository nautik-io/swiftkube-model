...
public extension core.v1 {
	...
	struct CSIPersistentVolumeSource: KubernetesResource {
		...
		///
		public var nodeExpandSecretRef: core.v1.SecretReference?
		///
		...
		public init(
			...
			driver: String,
			fsType: String? = nil,
			nodeExpandSecretRef: core.v1.SecretReference? = nil,
			...
			self.driver = driver
			self.fsType = fsType
			self.nodeExpandSecretRef = nodeExpandSecretRef
...
public extension core.v1.CSIPersistentVolumeSource {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case driver = "driver"
		case fsType = "fsType"
		case nodeExpandSecretRef = "nodeExpandSecretRef"
	...
	init(from decoder: Decoder) throws {
		...
		self.nodeExpandSecretRef = try container.decodeIfPresent(core.v1.SecretReference.self, forKey: .nodeExpandSecretRef)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(nodeExpandSecretRef, forKey: .nodeExpandSecretRef)
