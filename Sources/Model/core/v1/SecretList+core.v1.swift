...
public extension core.v1 {
	...
	struct SecretList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = core.v1.Secret
		///
...
public extension core.v1.SecretList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([core.v1.Secret].self, forKey: .items)
	}
...
// MARK: - core.v1.SecretList + Sequence
