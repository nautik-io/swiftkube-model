...
public extension core.v1 {
	...
	struct PodTemplateList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = core.v1.PodTemplate
		///
...
/// Codable conformance
///
public extension core.v1.PodTemplateList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([core.v1.PodTemplate].self, forKey: .items)
	}
...
// MARK: - core.v1.PodTemplateList + Sequence
