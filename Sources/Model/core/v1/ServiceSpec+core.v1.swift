...
public extension core.v1 {
	...
	struct ServiceSpec: KubernetesResource {
		...
		///
		public var trafficDistribution: String?
		///
		...
		public init(
			...
			trafficDistribution: String? = nil,
			type: String? = nil
		) {
...
public extension core.v1.ServiceSpec {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case trafficDistribution = "trafficDistribution"
		case type = "type"
	}
	...
	init(from decoder: Decoder) throws {
		...
		self.trafficDistribution = try container.decodeIfPresent(String.self, forKey: .trafficDistribution)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(trafficDistribution, forKey: .trafficDistribution)
