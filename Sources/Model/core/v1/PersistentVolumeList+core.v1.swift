...
// MARK: - core.v1.PersistentVolumeList
...
/// Codable conformance
///
public extension core.v1.PersistentVolumeList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([core.v1.PersistentVolume].self, forKey: .items)
	}
...
// MARK: - core.v1.PersistentVolumeList + Sequence
