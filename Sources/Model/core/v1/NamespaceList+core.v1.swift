...
public extension core.v1 {
	...
	struct NamespaceList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = core.v1.Namespace
		///
...
/// Codable conformance
///
public extension core.v1.NamespaceList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([core.v1.Namespace].self, forKey: .items)
	}
...
// MARK: - core.v1.NamespaceList + Sequence
