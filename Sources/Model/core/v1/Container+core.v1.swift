...
public extension core.v1 {
	...
	struct Container: KubernetesResource {
		...
		///
		public var restartPolicyRules: [core.v1.ContainerRestartRule]?
		///
		...
		public init(
			...
			restartPolicyRules: [core.v1.ContainerRestartRule]? = nil,
			...
			self.restartPolicyRules = restartPolicyRules
...
public extension core.v1.Container {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case restartPolicyRules = "restartPolicyRules"
	...
	init(from decoder: Decoder) throws {
		...
		self.restartPolicyRules = try container.decodeIfPresent([core.v1.ContainerRestartRule].self, forKey: .restartPolicyRules)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(restartPolicyRules, forKey: .restartPolicyRules)
