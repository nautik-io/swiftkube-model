...
public extension rbac.v1 {
	...
	struct ClusterRoleList: KubernetesResource, KubernetesResourceList {
		...
		///
		public var items: [rbac.v1.ClusterRole]
		///
...
/// Codable conformance
///
public extension rbac.v1.ClusterRoleList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1.ClusterRole].self, forKey: .items)
	}
...
// MARK: - rbac.v1.ClusterRoleList + Sequence
