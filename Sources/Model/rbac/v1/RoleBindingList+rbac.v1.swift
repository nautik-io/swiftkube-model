...
public extension rbac.v1 {
	...
	struct RoleBindingList: KubernetesResource, KubernetesResourceList {
		...
		///
		public var items: [rbac.v1.RoleBinding]
		///
...
/// Codable conformance
///
public extension rbac.v1.RoleBindingList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1.RoleBinding].self, forKey: .items)
	}
...
// MARK: - rbac.v1.RoleBindingList + Sequence

///
/// Sequence iterator for KubernetesResourceList items
///
extension rbac.v1.RoleBindingList: Sequence {

	public typealias Element = rbac.v1.RoleBinding

	public func makeIterator() -> AnyIterator<rbac.v1.RoleBinding> {
