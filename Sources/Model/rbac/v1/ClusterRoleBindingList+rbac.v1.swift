...
// MARK: - rbac.v1.ClusterRoleBindingList
...
public extension rbac.v1 {
	...
	struct ClusterRoleBindingList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = rbac.v1.ClusterRoleBinding
		///
		...
		///
		public var items: [rbac.v1.ClusterRoleBinding]
		///
...
/// Codable conformance
///
public extension rbac.v1.ClusterRoleBindingList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1.ClusterRoleBinding].self, forKey: .items)
	}
...
// MARK: - rbac.v1.ClusterRoleBindingList + Sequence
...
extension rbac.v1.ClusterRoleBindingList: Sequence {
	...
	public func makeIterator() -> AnyIterator<rbac.v1.ClusterRoleBinding> {
