...
public extension GroupVersionResource {
	...
	private static func tryKind(_ kind: String) -> GroupVersionResource? {
		...
		case "mutatingadmissionpolicy":
			return GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1beta1", resource: "mutatingadmissionpolicies")
		case "mutatingadmissionpolicybinding":
			return GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1beta1", resource: "mutatingadmissionpolicybindings")
		...
		case "podcertificaterequest":
			return GroupVersionResource(group: "certificates.k8s.io", version: "v1alpha1", resource: "podcertificaterequests")
		case "lease":
		...
		case "deviceclass":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "deviceclasses")
		case "resourceclaim":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "resourceclaims")
		case "resourceclaimtemplate":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "resourceclaimtemplates")
		case "resourceslice":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "resourceslices")
