...
// MARK: - admissionregistration.v1beta1.Mutation
...
public extension admissionregistration.v1beta1 {
	...
	struct Mutation: KubernetesResource {
		...
		///
		public var applyConfiguration: admissionregistration.v1beta1.ApplyConfiguration?
		///
		...
		///
		public var jsonPatch: admissionregistration.v1beta1.JSONPatch?
		///
		...
		///
		public init(
			applyConfiguration: admissionregistration.v1beta1.ApplyConfiguration? = nil,
			jsonPatch: admissionregistration.v1beta1.JSONPatch? = nil,
			patchType: String
		) {
...
/// Codable conformance
///
public extension admissionregistration.v1beta1.Mutation {
	...
	init(from decoder: Decoder) throws {
		...
		self.applyConfiguration = try container.decodeIfPresent(admissionregistration.v1beta1.ApplyConfiguration.self, forKey: .applyConfiguration)
		self.jsonPatch = try container.decodeIfPresent(admissionregistration.v1beta1.JSONPatch.self, forKey: .jsonPatch)
