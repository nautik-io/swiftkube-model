...
// MARK: - admissionregistration.v1.ValidatingWebhookConfigurationList
...
public extension admissionregistration.v1 {
	...
	struct ValidatingWebhookConfigurationList: KubernetesResource, KubernetesResourceList {
		...
		///
		public var items: [admissionregistration.v1.ValidatingWebhookConfiguration]
		///
...
/// Codable conformance
///
public extension admissionregistration.v1.ValidatingWebhookConfigurationList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([admissionregistration.v1.ValidatingWebhookConfiguration].self, forKey: .items)
	}
...
// MARK: - admissionregistration.v1.ValidatingWebhookConfigurationList + Sequence
