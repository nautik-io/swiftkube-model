...
// MARK: - admissionregistration.v1.MatchResources
...
public extension admissionregistration.v1 {
	...
	struct MatchResources: KubernetesResource {
		...
		///
		public var excludeResourceRules: [admissionregistration.v1.NamedRuleWithOperations]?
		///
		...
		///
		public var resourceRules: [admissionregistration.v1.NamedRuleWithOperations]?
		///
		/// Default memberwise initializer
		///
		public init(
			excludeResourceRules: [admissionregistration.v1.NamedRuleWithOperations]? = nil,
			matchPolicy: String? = nil,
			namespaceSelector: meta.v1.LabelSelector? = nil,
			objectSelector: meta.v1.LabelSelector? = nil,
			resourceRules: [admissionregistration.v1.NamedRuleWithOperations]? = nil
		) {
...
/// Codable conformance
///
public extension admissionregistration.v1.MatchResources {
	...
	init(from decoder: Decoder) throws {
		...
		self.excludeResourceRules = try container.decodeIfPresent([admissionregistration.v1.NamedRuleWithOperations].self, forKey: .excludeResourceRules)
		...
		self.resourceRules = try container.decodeIfPresent([admissionregistration.v1.NamedRuleWithOperations].self, forKey: .resourceRules)
	}
