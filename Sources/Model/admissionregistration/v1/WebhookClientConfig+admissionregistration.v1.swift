...
// MARK: - admissionregistration.v1.WebhookClientConfig
...
public extension admissionregistration.v1 {
	...
	struct WebhookClientConfig: KubernetesResource {
		...
		///
		public var service: admissionregistration.v1.ServiceReference?
		///
		...
		public init(
			caBundle: String? = nil,
			service: admissionregistration.v1.ServiceReference? = nil,
			url: String? = nil
		) {
...
/// Codable conformance
///
public extension admissionregistration.v1.WebhookClientConfig {
