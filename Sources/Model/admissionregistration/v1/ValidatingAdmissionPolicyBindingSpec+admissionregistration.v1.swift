...
// MARK: - admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec
...
public extension admissionregistration.v1 {
	...
	struct ValidatingAdmissionPolicyBindingSpec: KubernetesResource {
		...
		///
		public var matchResources: admissionregistration.v1.MatchResources?
		///
		/// paramRef specifies the parameter resource used to configure the admission control policy. It should point to a resource of the type specified in ParamKind of the bound ValidatingAdmissionPolicy. If the policy specifies a ParamKind and the resource referred to by ParamRef does not exist, this binding is considered mis-configured and the FailurePolicy of the ValidatingAdmissionPolicy applied. If the policy does not specify a ParamKind then this field is ignored, and the rules are evaluated without a param.
		///
		public var paramRef: admissionregistration.v1.ParamRef?
		///
		...
		///
		public init(
			matchResources: admissionregistration.v1.MatchResources? = nil,
			paramRef: admissionregistration.v1.ParamRef? = nil,
...
/// Codable conformance
///
public extension admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.matchResources = try container.decodeIfPresent(admissionregistration.v1.MatchResources.self, forKey: .matchResources)
		self.paramRef = try container.decodeIfPresent(admissionregistration.v1.ParamRef.self, forKey: .paramRef)
