...
// MARK: - admissionregistration.v1.ValidatingAdmissionPolicyStatus
...
public extension admissionregistration.v1 {
	...
	struct ValidatingAdmissionPolicyStatus: KubernetesResource {
		...
		///
		public var typeChecking: admissionregistration.v1.TypeChecking?
		///
		...
		public init(
			...
			typeChecking: admissionregistration.v1.TypeChecking? = nil
		) {
...
/// Codable conformance
///
public extension admissionregistration.v1.ValidatingAdmissionPolicyStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.typeChecking = try container.decodeIfPresent(admissionregistration.v1.TypeChecking.self, forKey: .typeChecking)
	}
