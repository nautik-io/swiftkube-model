...
// MARK: - admissionregistration.v1alpha1.NamedRuleWithOperations
...
public extension admissionregistration.v1alpha1 {
	...
	///
	struct NamedRuleWithOperations: KubernetesResource {
		///
...
/// Codable conformance
///
public extension admissionregistration.v1alpha1.NamedRuleWithOperations {
