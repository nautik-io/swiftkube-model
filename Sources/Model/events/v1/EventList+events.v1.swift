...
public extension events.v1 {
	...
	struct EventList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = events.v1.Event
		///
		...
		///
		public var items: [events.v1.Event]
		///
		/// Default memberwise initializer
		///
		public init(
			metadata: meta.v1.ListMeta? = nil,
			items: [events.v1.Event]
		) {
...
/// Codable conformance
///
public extension events.v1.EventList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([events.v1.Event].self, forKey: .items)
	}
...
// MARK: - events.v1.EventList + Sequence

///
/// Sequence iterator for KubernetesResourceList items
///
extension events.v1.EventList: Sequence {

	public typealias Element = events.v1.Event

	public func makeIterator() -> AnyIterator<events.v1.Event> {
