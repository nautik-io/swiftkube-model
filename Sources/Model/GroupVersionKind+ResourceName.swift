...
public extension GroupVersionKind {
	...
	private static func tryKind(_ kind: String) -> GroupVersionKind? {
		...
		case "validatingadmissionpolicy":
			return GroupVersionKind.admissionregistrationV1ValidatingAdmissionPolicy
		case "validatingadmissionpolicybinding":
			return GroupVersionKind.admissionregistrationV1ValidatingAdmissionPolicyBinding
		case "validatingwebhookconfiguration":
			return GroupVersionKind.admissionregistrationV1ValidatingWebhookConfiguration
		case "mutatingadmissionpolicy":
			return GroupVersionKind.admissionregistrationV1Beta1MutatingAdmissionPolicy
		case "mutatingadmissionpolicybinding":
			return GroupVersionKind.admissionregistrationV1Beta1MutatingAdmissionPolicyBinding
		...
		case "clustertrustbundle":
			return GroupVersionKind.certificatesV1Beta1ClusterTrustBundle
		case "podcertificaterequest":
			return GroupVersionKind.certificatesV1Alpha1PodCertificateRequest
		case "lease":
			return GroupVersionKind.coordinationV1Lease
		case "leasecandidate":
			return GroupVersionKind.coordinationV1Beta1LeaseCandidate
		case "endpointslice":
			return GroupVersionKind.discoveryV1EndpointSlice
		case "flowschema":
			return GroupVersionKind.flowcontrolV1FlowSchema
		case "prioritylevelconfiguration":
			return GroupVersionKind.flowcontrolV1PriorityLevelConfiguration
		case "storageversion":
			return GroupVersionKind.internalV1Alpha1StorageVersion
		case "ipaddress":
			return GroupVersionKind.networkingV1IPAddress
		case "ingress":
		...
		case "servicecidr":
			return GroupVersionKind.networkingV1ServiceCIDR
		case "runtimeclass":
		...
		case "deviceclass":
			return GroupVersionKind.resourceV1DeviceClass
		case "resourceclaim":
			return GroupVersionKind.resourceV1ResourceClaim
		case "resourceclaimtemplate":
			return GroupVersionKind.resourceV1ResourceClaimTemplate
		case "resourceslice":
			return GroupVersionKind.resourceV1ResourceSlice
		case "devicetaintrule":
			return GroupVersionKind.resourceV1Alpha3DeviceTaintRule
		case "priorityclass":
		...
		case "volumeattributesclass":
			return GroupVersionKind.storageV1VolumeAttributesClass
		case "storageversionmigration":
			return GroupVersionKind.storagemigrationV1Alpha1StorageVersionMigration
		default:
			return nil
		}
	}
