...
/// Codable conformance
///
public extension apiregistration.v1.APIServiceStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.conditions = try container.decodeIfPresent([apiregistration.v1.APIServiceCondition].self, forKey: .conditions)
	}
