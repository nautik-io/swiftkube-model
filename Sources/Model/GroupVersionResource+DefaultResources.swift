...
public extension GroupVersionResource {
	...
	static let admissionregistrationV1ValidatingAdmissionPolicy = GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1", resource: "validatingadmissionpolicies")
	static let admissionregistrationV1ValidatingAdmissionPolicyBinding = GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1", resource: "validatingadmissionpolicybindings")
	...
	static let admissionregistrationV1Beta1MutatingAdmissionPolicy = GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1beta1", resource: "mutatingadmissionpolicies")
	static let admissionregistrationV1Beta1MutatingAdmissionPolicyBinding = GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1beta1", resource: "mutatingadmissionpolicybindings")
	static let admissionregistrationV1Alpha1MutatingAdmissionPolicy = GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1alpha1", resource: "mutatingadmissionpolicies")
	static let admissionregistrationV1Alpha1MutatingAdmissionPolicyBinding = GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1alpha1", resource: "mutatingadmissionpolicybindings")
	...
	static let certificatesV1Alpha1ClusterTrustBundle = GroupVersionResource(group: "certificates.k8s.io", version: "v1alpha1", resource: "clustertrustbundles")
	static let certificatesV1Alpha1PodCertificateRequest = GroupVersionResource(group: "certificates.k8s.io", version: "v1alpha1", resource: "podcertificaterequests")
	static let coordinationV1Lease = GroupVersionResource(group: "coordination.k8s.io", version: "v1", resource: "leases")
	static let coordinationV1Beta1LeaseCandidate = GroupVersionResource(group: "coordination.k8s.io", version: "v1beta1", resource: "leasecandidates")
	static let coordinationV1Alpha2LeaseCandidate = GroupVersionResource(group: "coordination.k8s.io", version: "v1alpha2", resource: "leasecandidates")
	...
	static let networkingV1IPAddress = GroupVersionResource(group: "networking.k8s.io", version: "v1", resource: "ipaddresses")
	...
	static let networkingV1ServiceCIDR = GroupVersionResource(group: "networking.k8s.io", version: "v1", resource: "servicecidrs")
	static let networkingV1Beta1IPAddress = GroupVersionResource(group: "networking.k8s.io", version: "v1beta1", resource: "ipaddresses")
	static let networkingV1Beta1ServiceCIDR = GroupVersionResource(group: "networking.k8s.io", version: "v1beta1", resource: "servicecidrs")
	...
	static let resourceV1DeviceClass = GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "deviceclasses")
	static let resourceV1ResourceClaim = GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "resourceclaims")
	static let resourceV1ResourceClaimTemplate = GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "resourceclaimtemplates")
	static let resourceV1ResourceSlice = GroupVersionResource(group: "resource.k8s.io", version: "v1", resource: "resourceslices")
	static let resourceV1Beta2DeviceClass = GroupVersionResource(group: "resource.k8s.io", version: "v1beta2", resource: "deviceclasses")
	static let resourceV1Beta2ResourceClaim = GroupVersionResource(group: "resource.k8s.io", version: "v1beta2", resource: "resourceclaims")
	static let resourceV1Beta2ResourceClaimTemplate = GroupVersionResource(group: "resource.k8s.io", version: "v1beta2", resource: "resourceclaimtemplates")
	static let resourceV1Beta2ResourceSlice = GroupVersionResource(group: "resource.k8s.io", version: "v1beta2", resource: "resourceslices")
	static let resourceV1Beta1DeviceClass = GroupVersionResource(group: "resource.k8s.io", version: "v1beta1", resource: "deviceclasses")
	static let resourceV1Beta1ResourceClaim = GroupVersionResource(group: "resource.k8s.io", version: "v1beta1", resource: "resourceclaims")
	static let resourceV1Beta1ResourceClaimTemplate = GroupVersionResource(group: "resource.k8s.io", version: "v1beta1", resource: "resourceclaimtemplates")
	static let resourceV1Beta1ResourceSlice = GroupVersionResource(group: "resource.k8s.io", version: "v1beta1", resource: "resourceslices")
	static let resourceV1Alpha3DeviceTaintRule = GroupVersionResource(group: "resource.k8s.io", version: "v1alpha3", resource: "devicetaintrules")
	...
	static let storageV1VolumeAttributesClass = GroupVersionResource(group: "storage.k8s.io", version: "v1", resource: "volumeattributesclasses")
	static let storageV1Beta1VolumeAttributesClass = GroupVersionResource(group: "storage.k8s.io", version: "v1beta1", resource: "volumeattributesclasses")
	...
	static let storagemigrationV1Alpha1StorageVersionMigration = GroupVersionResource(group: "storagemigration.k8s.io", version: "v1alpha1", resource: "storageversionmigrations")
}
