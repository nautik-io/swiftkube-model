...
public extension GroupVersionKind {
	...
	init?<R: KubernetesAPIResource>(of type: R.Type) {
		...
		case is admissionregistration.v1beta1.MutatingAdmissionPolicy.Type:
			self = .admissionregistrationV1Beta1MutatingAdmissionPolicy
		case is admissionregistration.v1beta1.MutatingAdmissionPolicyBinding.Type:
			self = .admissionregistrationV1Beta1MutatingAdmissionPolicyBinding
		...
		case is certificates.v1alpha1.PodCertificateRequest.Type:
			self = .certificatesV1Alpha1PodCertificateRequest
		...
		case is resource.v1.DeviceClass.Type:
			self = .resourceV1DeviceClass
		case is resource.v1.ResourceClaim.Type:
			self = .resourceV1ResourceClaim
		case is resource.v1.ResourceClaimTemplate.Type:
			self = .resourceV1ResourceClaimTemplate
		case is resource.v1.ResourceSlice.Type:
			self = .resourceV1ResourceSlice
		...
		case is storage.v1.VolumeAttributesClass.Type:
			self = .storageV1VolumeAttributesClass
