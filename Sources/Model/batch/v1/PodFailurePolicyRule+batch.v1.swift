...
public extension batch.v1 {
	...
	struct PodFailurePolicyRule: KubernetesResource {
		...
		public init(
			...
			onPodConditions: [batch.v1.PodFailurePolicyOnPodConditionsPattern]? = nil
		) {
			self.action = action
...
public extension batch.v1.PodFailurePolicyRule {
	...
	init(from decoder: Decoder) throws {
		...
		self.onPodConditions = try container.decodeIfPresent([batch.v1.PodFailurePolicyOnPodConditionsPattern].self, forKey: .onPodConditions)
	}
