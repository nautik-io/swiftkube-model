...
public extension batch.v1 {
	...
	struct JobList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = batch.v1.Job
		///
...
/// Codable conformance
///
public extension batch.v1.JobList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([batch.v1.Job].self, forKey: .items)
	}
...
// MARK: - batch.v1.JobList + Sequence
...
extension batch.v1.JobList: Sequence {
	...
	public func makeIterator() -> AnyIterator<batch.v1.Job> {
