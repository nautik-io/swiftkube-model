...
// MARK: - storage.v1.VolumeAttachment
...
public extension storage.v1 {
		...
		StatusHavingResource
	{
		...
		///
		public typealias List = storage.v1.VolumeAttachmentList
		///
...
/// Codable conformance
///
public extension storage.v1.VolumeAttachment {
	...
	init(from decoder: Decoder) throws {
		...
		self.spec = try container.decode(storage.v1.VolumeAttachmentSpec.self, forKey: .spec)
		self.status = try container.decodeIfPresent(storage.v1.VolumeAttachmentStatus.self, forKey: .status)
	}
