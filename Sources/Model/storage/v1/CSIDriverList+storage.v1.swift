...
public extension storage.v1 {
	...
	struct CSIDriverList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = storage.v1.CSIDriver
		///
...
/// Codable conformance
///
public extension storage.v1.CSIDriverList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([storage.v1.CSIDriver].self, forKey: .items)
	}
...
// MARK: - storage.v1.CSIDriverList + Sequence
