...
// MARK: - storage.v1.StorageClassList
...
public extension storage.v1 {
	...
	struct StorageClassList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = storage.v1.StorageClass
		///
...
/// Codable conformance
///
public extension storage.v1.StorageClassList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([storage.v1.StorageClass].self, forKey: .items)
	}
...
// MARK: - storage.v1.StorageClassList + Sequence
