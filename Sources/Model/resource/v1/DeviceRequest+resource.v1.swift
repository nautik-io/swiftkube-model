...
// MARK: - resource.v1.DeviceRequest
...
public extension resource.v1 {
	...
	struct DeviceRequest: KubernetesResource {
		...
		///
		public var exactly: resource.v1.ExactDeviceRequest?
		///
		...
		///
		public var firstAvailable: [resource.v1.DeviceSubRequest]?
		///
		...
		///
		public init(
			exactly: resource.v1.ExactDeviceRequest? = nil,
			firstAvailable: [resource.v1.DeviceSubRequest]? = nil,
			name: String
		) {
...
/// Codable conformance
///
public extension resource.v1.DeviceRequest {
	...
	init(from decoder: Decoder) throws {
		...
		self.exactly = try container.decodeIfPresent(resource.v1.ExactDeviceRequest.self, forKey: .exactly)
		self.firstAvailable = try container.decodeIfPresent([resource.v1.DeviceSubRequest].self, forKey: .firstAvailable)
