...
// MARK: - resource.v1.ExactDeviceRequest
...
public extension resource.v1 {
	...
	///
	struct ExactDeviceRequest: KubernetesResource {
		///
		...
		///
		public var capacity: resource.v1.CapacityRequirements?
		///
		...
		///
		public var tolerations: [resource.v1.DeviceToleration]?
		///
		...
		public init(
			...
			capacity: resource.v1.CapacityRequirements? = nil,
			count: Int64? = nil,
			deviceClassName: String,
			selectors: [resource.v1.DeviceSelector]? = nil,
			tolerations: [resource.v1.DeviceToleration]? = nil
		) {
...
/// Codable conformance
///
public extension resource.v1.ExactDeviceRequest {
	...
	init(from decoder: Decoder) throws {
		...
		self.capacity = try container.decodeIfPresent(resource.v1.CapacityRequirements.self, forKey: .capacity)
		...
		self.tolerations = try container.decodeIfPresent([resource.v1.DeviceToleration].self, forKey: .tolerations)
	}
