...
// MARK: - resource.v1.AllocationResult
...
public extension resource.v1 {
	...
	struct AllocationResult: KubernetesResource {
		...
		///
		public var devices: resource.v1.DeviceAllocationResult?
		///
		...
		public init(
			...
			devices: resource.v1.DeviceAllocationResult? = nil,
...
/// Codable conformance
///
public extension resource.v1.AllocationResult {
	...
	init(from decoder: Decoder) throws {
		...
		self.devices = try container.decodeIfPresent(resource.v1.DeviceAllocationResult.self, forKey: .devices)
