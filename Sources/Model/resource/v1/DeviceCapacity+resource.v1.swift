...
// MARK: - resource.v1.DeviceCapacity
...
public extension resource.v1 {
	...
	struct DeviceCapacity: KubernetesResource {
		...
		///
		public var requestPolicy: resource.v1.CapacityRequestPolicy?
		///
		...
		///
		public init(
			requestPolicy: resource.v1.CapacityRequestPolicy? = nil,
			value: Quantity
		) {
...
/// Codable conformance
///
public extension resource.v1.DeviceCapacity {
	...
	init(from decoder: Decoder) throws {
		...
		self.requestPolicy = try container.decodeIfPresent(resource.v1.CapacityRequestPolicy.self, forKey: .requestPolicy)
