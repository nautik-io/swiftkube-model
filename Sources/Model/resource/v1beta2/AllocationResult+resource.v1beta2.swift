...
// MARK: - resource.v1beta2.AllocationResult
...
public extension resource.v1beta2 {
	...
	struct AllocationResult: KubernetesResource {
		...
		///
		public var devices: resource.v1beta2.DeviceAllocationResult?
		///
		...
		public init(
			...
			devices: resource.v1beta2.DeviceAllocationResult? = nil,
...
/// Codable conformance
///
public extension resource.v1beta2.AllocationResult {
	...
	init(from decoder: Decoder) throws {
		...
		self.devices = try container.decodeIfPresent(resource.v1beta2.DeviceAllocationResult.self, forKey: .devices)
