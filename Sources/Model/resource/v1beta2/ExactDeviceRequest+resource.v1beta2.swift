...
// MARK: - resource.v1beta2.ExactDeviceRequest
...
public extension resource.v1beta2 {
	...
	struct ExactDeviceRequest: KubernetesResource {
		...
		///
		public var capacity: resource.v1beta2.CapacityRequirements?
		///
		...
		public init(
			...
			capacity: resource.v1beta2.CapacityRequirements? = nil,
			count: Int64? = nil,
...
/// Codable conformance
///
public extension resource.v1beta2.ExactDeviceRequest {
	...
	init(from decoder: Decoder) throws {
		...
		self.capacity = try container.decodeIfPresent(resource.v1beta2.CapacityRequirements.self, forKey: .capacity)
