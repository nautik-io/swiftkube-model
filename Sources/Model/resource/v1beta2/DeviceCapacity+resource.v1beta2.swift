...
public extension resource.v1beta2 {
	...
	struct DeviceCapacity: KubernetesResource {
		...
		///
		public var requestPolicy: resource.v1beta2.CapacityRequestPolicy?
		///
		...
		///
		public init(
			requestPolicy: resource.v1beta2.CapacityRequestPolicy? = nil,
			value: Quantity
		) {
...
public extension resource.v1beta2.DeviceCapacity {
	...
	init(from decoder: Decoder) throws {
		...
		self.requestPolicy = try container.decodeIfPresent(resource.v1beta2.CapacityRequestPolicy.self, forKey: .requestPolicy)
