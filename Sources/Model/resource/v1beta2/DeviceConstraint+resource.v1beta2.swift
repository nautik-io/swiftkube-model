...
// MARK: - resource.v1beta2.DeviceConstraint
...
/// Codable conformance
///
public extension resource.v1beta2.DeviceConstraint {

	private enum CodingKeys: String, CodingKey {

		case distinctAttribute = "distinctAttribute"
	...
	init(from decoder: Decoder) throws {
		...
		self.distinctAttribute = try container.decodeIfPresent(String.self, forKey: .distinctAttribute)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(distinctAttribute, forKey: .distinctAttribute)
