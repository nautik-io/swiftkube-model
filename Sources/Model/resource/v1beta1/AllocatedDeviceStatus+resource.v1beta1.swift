...
// MARK: - resource.v1beta1.AllocatedDeviceStatus
...
public extension resource.v1beta1 {
	...
	struct AllocatedDeviceStatus: KubernetesResource {
		...
		///
		public var networkData: resource.v1beta1.NetworkDeviceData?
		///
		...
		public init(
			...
			device: String,
			driver: String,
			networkData: resource.v1beta1.NetworkDeviceData? = nil,
			pool: String,
			shareID: String? = nil
		) {
...
/// Codable conformance
///
public extension resource.v1beta1.AllocatedDeviceStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.networkData = try container.decodeIfPresent(resource.v1beta1.NetworkDeviceData.self, forKey: .networkData)
