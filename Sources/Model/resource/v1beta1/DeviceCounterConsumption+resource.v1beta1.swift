...
// MARK: - resource.v1beta1.DeviceCounterConsumption
...
public extension resource.v1beta1 {
	...
	struct DeviceCounterConsumption: KubernetesResource {
		...
		///
		public var counters: [String: resource.v1beta1.Counter]
		///
		/// Default memberwise initializer
		///
		public init(
			counterSet: String,
			counters: [String: resource.v1beta1.Counter]
		) {
...
/// Codable conformance
///
public extension resource.v1beta1.DeviceCounterConsumption {
	...
	init(from decoder: Decoder) throws {
		...
		self.counters = try container.decode([String: resource.v1beta1.Counter].self, forKey: .counters)
	}
