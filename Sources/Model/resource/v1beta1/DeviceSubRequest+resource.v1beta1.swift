...
// MARK: - resource.v1beta1.DeviceSubRequest
...
public extension resource.v1beta1 {
	...
	struct DeviceSubRequest: KubernetesResource {
		...
		///
		public var capacity: resource.v1beta1.CapacityRequirements?
		///
		...
		public init(
			...
			capacity: resource.v1beta1.CapacityRequirements? = nil,
			count: Int64? = nil,
...
/// Codable conformance
///
public extension resource.v1beta1.DeviceSubRequest {
	...
	init(from decoder: Decoder) throws {
		...
		self.capacity = try container.decodeIfPresent(resource.v1beta1.CapacityRequirements.self, forKey: .capacity)
