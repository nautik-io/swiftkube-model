...
public extension resource.v1beta1 {
	...
	struct ResourceSliceSpec: KubernetesResource {
		...
		///
		public var sharedCounters: [resource.v1beta1.CounterSet]?
		///
		...
		public init(
			...
			sharedCounters: [resource.v1beta1.CounterSet]? = nil
		) {
...
public extension resource.v1beta1.ResourceSliceSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.sharedCounters = try container.decodeIfPresent([resource.v1beta1.CounterSet].self, forKey: .sharedCounters)
	}
