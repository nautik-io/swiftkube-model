...
public extension GroupVersionKind {
	...
	static let admissionregistrationV1ValidatingAdmissionPolicy = GroupVersionKind(group: "admissionregistration.k8s.io", version: "v1", kind: "ValidatingAdmissionPolicy")
	static let admissionregistrationV1ValidatingAdmissionPolicyBinding = GroupVersionKind(group: "admissionregistration.k8s.io", version: "v1", kind: "ValidatingAdmissionPolicyBinding")
	...
	static let admissionregistrationV1Beta1MutatingAdmissionPolicy = GroupVersionKind(group: "admissionregistration.k8s.io", version: "v1beta1", kind: "MutatingAdmissionPolicy")
	static let admissionregistrationV1Beta1MutatingAdmissionPolicyBinding = GroupVersionKind(group: "admissionregistration.k8s.io", version: "v1beta1", kind: "MutatingAdmissionPolicyBinding")
	static let admissionregistrationV1Alpha1MutatingAdmissionPolicy = GroupVersionKind(group: "admissionregistration.k8s.io", version: "v1alpha1", kind: "MutatingAdmissionPolicy")
	static let admissionregistrationV1Alpha1MutatingAdmissionPolicyBinding = GroupVersionKind(group: "admissionregistration.k8s.io", version: "v1alpha1", kind: "MutatingAdmissionPolicyBinding")
	...
	static let certificatesV1Beta1ClusterTrustBundle = GroupVersionKind(group: "certificates.k8s.io", version: "v1beta1", kind: "ClusterTrustBundle")
	...
	static let certificatesV1Alpha1PodCertificateRequest = GroupVersionKind(group: "certificates.k8s.io", version: "v1alpha1", kind: "PodCertificateRequest")
	static let coordinationV1Lease = GroupVersionKind(group: "coordination.k8s.io", version: "v1", kind: "Lease")
	static let coordinationV1Beta1LeaseCandidate = GroupVersionKind(group: "coordination.k8s.io", version: "v1beta1", kind: "LeaseCandidate")
	static let coordinationV1Alpha2LeaseCandidate = GroupVersionKind(group: "coordination.k8s.io", version: "v1alpha2", kind: "LeaseCandidate")
	...
	static let flowcontrolV1FlowSchema = GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", version: "v1", kind: "FlowSchema")
	static let flowcontrolV1PriorityLevelConfiguration = GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", version: "v1", kind: "PriorityLevelConfiguration")
	...
	static let networkingV1IPAddress = GroupVersionKind(group: "networking.k8s.io", version: "v1", kind: "IPAddress")
	...
	static let networkingV1ServiceCIDR = GroupVersionKind(group: "networking.k8s.io", version: "v1", kind: "ServiceCIDR")
	static let networkingV1Beta1IPAddress = GroupVersionKind(group: "networking.k8s.io", version: "v1beta1", kind: "IPAddress")
	static let networkingV1Beta1ServiceCIDR = GroupVersionKind(group: "networking.k8s.io", version: "v1beta1", kind: "ServiceCIDR")
	...
	static let resourceV1DeviceClass = GroupVersionKind(group: "resource.k8s.io", version: "v1", kind: "DeviceClass")
	static let resourceV1ResourceClaim = GroupVersionKind(group: "resource.k8s.io", version: "v1", kind: "ResourceClaim")
	static let resourceV1ResourceClaimTemplate = GroupVersionKind(group: "resource.k8s.io", version: "v1", kind: "ResourceClaimTemplate")
	static let resourceV1ResourceSlice = GroupVersionKind(group: "resource.k8s.io", version: "v1", kind: "ResourceSlice")
	static let resourceV1Beta2DeviceClass = GroupVersionKind(group: "resource.k8s.io", version: "v1beta2", kind: "DeviceClass")
	static let resourceV1Beta2ResourceClaim = GroupVersionKind(group: "resource.k8s.io", version: "v1beta2", kind: "ResourceClaim")
	static let resourceV1Beta2ResourceClaimTemplate = GroupVersionKind(group: "resource.k8s.io", version: "v1beta2", kind: "ResourceClaimTemplate")
	static let resourceV1Beta2ResourceSlice = GroupVersionKind(group: "resource.k8s.io", version: "v1beta2", kind: "ResourceSlice")
	static let resourceV1Beta1DeviceClass = GroupVersionKind(group: "resource.k8s.io", version: "v1beta1", kind: "DeviceClass")
	static let resourceV1Beta1ResourceClaim = GroupVersionKind(group: "resource.k8s.io", version: "v1beta1", kind: "ResourceClaim")
	static let resourceV1Beta1ResourceClaimTemplate = GroupVersionKind(group: "resource.k8s.io", version: "v1beta1", kind: "ResourceClaimTemplate")
	static let resourceV1Beta1ResourceSlice = GroupVersionKind(group: "resource.k8s.io", version: "v1beta1", kind: "ResourceSlice")
	static let resourceV1Alpha3DeviceTaintRule = GroupVersionKind(group: "resource.k8s.io", version: "v1alpha3", kind: "DeviceTaintRule")
	...
	static let storageV1VolumeAttributesClass = GroupVersionKind(group: "storage.k8s.io", version: "v1", kind: "VolumeAttributesClass")
	static let storageV1Beta1VolumeAttributesClass = GroupVersionKind(group: "storage.k8s.io", version: "v1beta1", kind: "VolumeAttributesClass")
	static let storageV1Alpha1VolumeAttributesClass = GroupVersionKind(group: "storage.k8s.io", version: "v1alpha1", kind: "VolumeAttributesClass")
	static let storagemigrationV1Alpha1StorageVersionMigration = GroupVersionKind(group: "storagemigration.k8s.io", version: "v1alpha1", kind: "StorageVersionMigration")
}
