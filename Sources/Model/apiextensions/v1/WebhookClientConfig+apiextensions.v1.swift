...
// MARK: - apiextensions.v1.WebhookClientConfig
...
public extension apiextensions.v1 {
	...
	struct WebhookClientConfig: KubernetesResource {
		...
		///
		public var service: apiextensions.v1.ServiceReference?
		///
		...
		public init(
			caBundle: String? = nil,
			service: apiextensions.v1.ServiceReference? = nil,
			url: String? = nil
		) {
...
/// Codable conformance
///
public extension apiextensions.v1.WebhookClientConfig {
	...
	init(from decoder: Decoder) throws {
		...
		self.service = try container.decodeIfPresent(apiextensions.v1.ServiceReference.self, forKey: .service)
