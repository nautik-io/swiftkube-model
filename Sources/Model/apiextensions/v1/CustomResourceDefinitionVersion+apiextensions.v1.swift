...
public extension apiextensions.v1 {
	...
	struct CustomResourceDefinitionVersion: KubernetesResource {
		...
		///
		public var selectableFields: [apiextensions.v1.SelectableField]?
		///
		...
		public init(
			...
			selectableFields: [apiextensions.v1.SelectableField]? = nil,
			served: Bool,
			storage: Bool,
...
public extension apiextensions.v1.CustomResourceDefinitionVersion {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case name = "name"
		case schema = "schema"
		case selectableFields = "selectableFields"
		case served = "served"
	...
	init(from decoder: Decoder) throws {
		...
		self.selectableFields = try container.decodeIfPresent([apiextensions.v1.SelectableField].self, forKey: .selectableFields)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(selectableFields, forKey: .selectableFields)
