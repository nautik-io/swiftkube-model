...
/// Codable conformance
///
public extension scheduling.v1.PriorityClassList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([scheduling.v1.PriorityClass].self, forKey: .items)
	}
...
// MARK: - scheduling.v1.PriorityClassList + Sequence
