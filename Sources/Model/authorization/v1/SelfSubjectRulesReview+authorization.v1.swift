...
// MARK: - authorization.v1.SelfSubjectRulesReview
...
/// Codable conformance
///
public extension authorization.v1.SelfSubjectRulesReview {
	...
	init(from decoder: Decoder) throws {
		...
		self.spec = try container.decode(authorization.v1.SelfSubjectRulesReviewSpec.self, forKey: .spec)
		self.status = try container.decodeIfPresent(authorization.v1.SubjectRulesReviewStatus.self, forKey: .status)
	}
