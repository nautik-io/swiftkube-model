...
// MARK: - apps.v1.ControllerRevisionList
...
public extension apps.v1 {
	...
	struct ControllerRevisionList: KubernetesResource, KubernetesResourceList {
		...
		///
		public var items: [apps.v1.ControllerRevision]
		///
...
/// Codable conformance
///
public extension apps.v1.ControllerRevisionList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([apps.v1.ControllerRevision].self, forKey: .items)
	}
...
// MARK: - apps.v1.ControllerRevisionList + Sequence

///
/// Sequence iterator for KubernetesResourceList items
///
extension apps.v1.ControllerRevisionList: Sequence {

	public typealias Element = apps.v1.ControllerRevision

	public func makeIterator() -> AnyIterator<apps.v1.ControllerRevision> {
