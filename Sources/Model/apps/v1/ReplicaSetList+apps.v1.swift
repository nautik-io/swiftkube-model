...
public extension apps.v1 {
	...
	struct ReplicaSetList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = apps.v1.ReplicaSet
		///
		...
		///
		public var items: [apps.v1.ReplicaSet]
		///
...
/// Codable conformance
///
public extension apps.v1.ReplicaSetList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([apps.v1.ReplicaSet].self, forKey: .items)
	}
...
// MARK: - apps.v1.ReplicaSetList + Sequence

///
/// Sequence iterator for KubernetesResourceList items
///
extension apps.v1.ReplicaSetList: Sequence {

	public typealias Element = apps.v1.ReplicaSet

	public func makeIterator() -> AnyIterator<apps.v1.ReplicaSet> {
