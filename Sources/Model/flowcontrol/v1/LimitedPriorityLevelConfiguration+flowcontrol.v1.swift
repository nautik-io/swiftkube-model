...
/// Kubernetes v1.34.6
/// flowcontrol.v1.LimitedPriorityLevelConfiguration
///

import Foundation

// MARK: - flowcontrol.v1.LimitedPriorityLevelConfiguration
...
public extension flowcontrol.v1 {
	...
	struct LimitedPriorityLevelConfiguration: KubernetesResource {
		...
		///
		public var borrowingLimitPercent: Int32?
		///
		...
		///
		public var limitResponse: flowcontrol.v1.LimitResponse?
		///
		...
		///
		public init(
			borrowingLimitPercent: Int32? = nil,
			lendablePercent: Int32? = nil,
			limitResponse: flowcontrol.v1.LimitResponse? = nil,
			nominalConcurrencyShares: Int32? = nil
		) {
			self.borrowingLimitPercent = borrowingLimitPercent
...
/// Codable conformance
///
public extension flowcontrol.v1.LimitedPriorityLevelConfiguration {

	private enum CodingKeys: String, CodingKey {

		case borrowingLimitPercent = "borrowingLimitPercent"
	...
	init(from decoder: Decoder) throws {
		...
		self.borrowingLimitPercent = try container.decodeIfPresent(Int32.self, forKey: .borrowingLimitPercent)
		self.lendablePercent = try container.decodeIfPresent(Int32.self, forKey: .lendablePercent)
		self.limitResponse = try container.decodeIfPresent(flowcontrol.v1.LimitResponse.self, forKey: .limitResponse)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(borrowingLimitPercent, forKey: .borrowingLimitPercent)
