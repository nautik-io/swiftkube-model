...
public extension flowcontrol.v1 {
	...
	struct FlowSchemaSpec: KubernetesResource {
		...
		///
		public var distinguisherMethod: flowcontrol.v1.FlowDistinguisherMethod?
		///
		...
		///
		public var priorityLevelConfiguration: flowcontrol.v1.PriorityLevelConfigurationReference
		///
		/// `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
		///
		public var rules: [flowcontrol.v1.PolicyRulesWithSubjects]?
		///
		/// Default memberwise initializer
		///
		public init(
			distinguisherMethod: flowcontrol.v1.FlowDistinguisherMethod? = nil,
			matchingPrecedence: Int32? = nil,
			priorityLevelConfiguration: flowcontrol.v1.PriorityLevelConfigurationReference,
			rules: [flowcontrol.v1.PolicyRulesWithSubjects]? = nil
		) {
...
/// Codable conformance
///
public extension flowcontrol.v1.FlowSchemaSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.distinguisherMethod = try container.decodeIfPresent(flowcontrol.v1.FlowDistinguisherMethod.self, forKey: .distinguisherMethod)
		self.matchingPrecedence = try container.decodeIfPresent(Int32.self, forKey: .matchingPrecedence)
		self.priorityLevelConfiguration = try container.decode(flowcontrol.v1.PriorityLevelConfigurationReference.self, forKey: .priorityLevelConfiguration)
		self.rules = try container.decodeIfPresent([flowcontrol.v1.PolicyRulesWithSubjects].self, forKey: .rules)
	}
