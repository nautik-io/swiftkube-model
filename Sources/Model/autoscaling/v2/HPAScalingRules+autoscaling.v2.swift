...
public extension autoscaling.v2.HPAScalingRules {
	...
	init(from decoder: Decoder) throws {
		...
		self.tolerance = try container.decodeIfPresent(Quantity.self, forKey: .tolerance)
	}
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(tolerance, forKey: .tolerance)
	}
}
